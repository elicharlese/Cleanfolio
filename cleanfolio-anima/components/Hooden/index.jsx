        ...
        <Body>
          ...
          <Hero>
            <FlexCol>
              ...
              <FlexRow>
                ...
                <Button2>
                  <DASHBOARD>
                    <span className="raleway-bold-portage-32px">{spanText4}</span>
                  </DASHBOARD>
                </Button2>
              </FlexRow>
            </FlexCol>
            <LogoHooden src={logoHooden} alt="logo-hooden" />
          </Hero>
          ...
          <Team>
            <BecomeAContributor>
              ...
              <Span19>{spanText6}</Span19>
            </BecomeAContributor>
            <OverlapGroup1>
              <Vector src="/img/vector-13@2x.png" alt="Vector" />
          ...
          <LiveDeveloping>
            ...
            <FlexRow1>
              ...
              <Button21>
                <DASHBOARD1>
                  <span>
                    <span className="raleway-bold-portage-32px">{spanText8}</span>
                  </span>
                </DASHBOARD1>
              </Button21>
            </FlexRow1>
