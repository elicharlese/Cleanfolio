        ...
        <Body>
          ...
          <Hero>
            <FlexCol>
              ...
              <FlexRow>
                ...
                <Button2>
                  <DASHBOARD>
                    <span className="raleway-bold-dairy-cream-32px">{spanText4}</span>
                  </DASHBOARD>
                </Button2>
              </FlexRow>
            </FlexCol>
            <LogoHalfAndHalf src={logoHalfAndHalf} alt="logo-half-and-half" />
          </Hero>
          ...
          <Team>
            ...
            <OverlapGroup1>
              ...
              <Vector src="/img/vector-16@2x.png" alt="Vector" />
            </OverlapGroup1>
          </Team>
          <LiveDeveloping>
            <DevEnvironment />
            <FlexRow1>
              ...
              <Button21>
                <DASHBOARD1>
                  <span>
                    <span className="raleway-bold-dairy-cream-32px">{spanText8}</span>
                  </span>
                </DASHBOARD1>
              </Button21>
            </FlexRow1>
