...
function ThePublic(props) {
  ...
  return (
    <div className="container-center-horizontal">
      <div className="the-public screen">
        <Body>
          <Navbar3 {...navbarProps} />
          <Hero>
            <FlexCol>
              ...
              <FlexRow>
                ...
                <Button2>
                  <DASHBOARD>
                    <span className="raleway-bold-cararra-32px">{spanText4}</span>
                  </DASHBOARD>
                </Button2>
              </FlexRow>
            </FlexCol>
            <LogoThePublic src={logoThePublic} alt="logo-the-public" />
          </Hero>
          ...
          <Team>
            <BecomeAContributor>
              ...
              <Span111>{spanText6}</Span111>
            </BecomeAContributor>
            <OverlapGroup1>
              <Vector src="/img/vector-15@2x.png" alt="Vector" />
          ...
          <LiveDeveloping>
            ...
            <FlexRow1>
              ...
              <Button21>
                <DASHBOARD1>
                  <span>
                    <span className="raleway-bold-cararra-32px">{spanText8}</span>
                  </span>
                </DASHBOARD1>
              </Button21>
            </FlexRow1>
