        ...
        <Body>
          ...
          <Hero>
            <FlexCol>
              ...
              <FlexRow>
                ...
                <Button2>
                  <DASHBOARD>
                    <span className="raleway-bold-orchid-32px">{spanText4}</span>
                  </DASHBOARD>
                </Button2>
              </FlexRow>
            </FlexCol>
            <LogoUniMeta src={logoUniMeta} alt="logo-uni-meta" />
          </Hero>
          ...
          <Team>
            <BecomeAContributor>
              ...
              <Span18>{spanText6}</Span18>
            </BecomeAContributor>
            <OverlapGroup1>
              <Vector src="/img/vector-12@2x.png" alt="Vector" />
          ...
          <LiveDeveloping>
            ...
            <FlexRow1>
              ...
              <Button21>
                <DASHBOARD1>
                  <span>
                    <span className="raleway-bold-orchid-32px">{spanText8}</span>
                  </span>
                </DASHBOARD1>
              </Button21>
            </FlexRow1>
