        ...
        <Body>
          ...
          <Hero>
            <FlexCol>
              ...
              <FlexRow>
                ...
                <Button2>
                  <DASHBOARD>
                    <span className="raleway-bold-seagull-32px">{spanText4}</span>
                  </DASHBOARD>
                </Button2>
              </FlexRow>
            </FlexCol>
          ...
          <Team>
            <BecomeAContributor>
              ...
              <Span118>{spanText6}</Span118>
            </BecomeAContributor>
            <OverlapGroup1>
              <Vector src="/img/vector-22@2x.png" alt="Vector" />
          ...
          <LiveDeveloping>
            ...
            <FlexRow1>
              ...
              <Button21>
                <DASHBOARD1>
                  <span>
                    <span className="raleway-bold-seagull-32px">{spanText8}</span>
                  </span>
                </DASHBOARD1>
              </Button21>
            </FlexRow1>
...
const CreativeECommerceCo = styled.div`
  ${RalewayNormalCapeCod80px}
  min-height: 282px;
  letter-spacing: 0;
`;
