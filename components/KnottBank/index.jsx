...
function KnottBank(props) {
  ...
  return (
    <div className="container-center-horizontal">
      <div className="knott-bank screen">
        <Body>
          <Navbar3 {...navbarProps} />
          <Hero>
            <FlexCol>
              ...
              <FlexRow>
                ...
                <Button2>
                  <DASHBOARD>
                    <span className="raleway-bold-de-york-32px">{spanText4}</span>
                  </DASHBOARD>
                </Button2>
              </FlexRow>
            </FlexCol>
            <LogoKnottBank src={logoKnottBank} alt="logo-knott-bank" />
          </Hero>
          ...
          <Team>
            <BecomeAContributor>
              ...
              <Span110>{spanText6}</Span110>
            </BecomeAContributor>
            <OverlapGroup1>
              <Vector src="/img/vector-14@2x.png" alt="Vector" />
          ...
          <LiveDeveloping>
            ...
            <FlexRow1>
              ...
              <Button21>
                <DASHBOARD1>
                  <span>
                    <span className="raleway-bold-fern-32px">{spanText8}</span>
                  </span>
                </DASHBOARD1>
              </Button21>
            </FlexRow1>
